...
public class ICCreatorDialog {
    ...
    public ICCreatorDialog(final Stage stage, final Map<Action, KeyAction> keyActions, final Map<String, KeyActionClass> classKeyActions) {
        this.stage = stage;
    ...
    public Optional<CreatedClass> getClassKeyCombo() {
        ...
        return Optional.of(new CreatedClass(textFieldClass.getText().strip(), classKC.get()));
    }
    ...
    public static Optional<CreatedClass> showAndWait(final Map<Action, KeyAction> keyActions, final Map<String, KeyActionClass> classKeyActions) {
        ...
        FXMLLoader loader = new FXMLLoader(ICCreatorDialog.class.getResource("/fxml/keymapv2/ICCreator.fxml"));
        loader.setControllerFactory(param -> new ICCreatorDialog(stage, keyActions, classKeyActions));
        ...
        return ((ICCreatorDialog) loader.getController()).getClassKeyCombo();
    }
    ...
    public static class CreatedClass {
        ...
        public CreatedClass(final String className, final KeyCombination shortcut) {
